const nodes = [
  ...
  },
  {
    ...
    children: [
      {
        text:
          'HTML/XML and tree-structured document editing, collaborative office productivity tools, '
      }
    ]
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        text:
          'application-sharing, and collaborative computer-aided media design tools.[1] In 2009 OT was adopted as a core '
      }
    ]
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        text:
          'technique behind the collaboration features in Apache Wave and Google Docs.'
      }
    ]
  }
]
